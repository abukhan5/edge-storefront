...
- Preview: https://main--edge-storefront--abukhan5.hlx.page/
- Live: https://main--edge-storefront--abukhan5.hlx.live/
...
1. Open the `edge-storefront` directory in your favorite IDE and start coding :)
